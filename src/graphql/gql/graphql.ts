...
export type GetProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductList', totalItems: number, items: Array<{ __typename?: 'Product', id: string, name: string, variants: Array<{ __typename?: 'ProductVariant', price: any, stockLevel: string }>, assets: Array<{ __typename?: 'Asset', preview: string }> }> } };
